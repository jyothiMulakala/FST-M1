...
public class  GitHub_RestAssured_Project{
	...
	String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIP0nSTzRpZfF85jsMIjOWwMeYAKuFZFlh/3au/IdgLOp";
	int sshKeyId = 0;
	
		//Request Specification
	RequestSpecification requestSpec = new RequestSpecBuilder().
				setBaseUri("https://api.github.com/user/keys").
				addHeader("Authorization", "token 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").
